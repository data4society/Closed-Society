...
ncos.Views.ChecksGrid = Backbone.MainGrid.extend({
  ...
  filters: function() {
    this.listenTo(this.options.collection,'reset',this.updateCounter);
  	...
  	$(this.$el).prepend('<div class="btn-group data-menu" data-toggle="buttons-radio"><button type="button" title="The whole list of inspected NGOs" class="btn active" data-toggle="tooltip" data-section="checks" data-filter="all">All inspections <span title="" class="label label-inverse tip-left">' + ncos.State.Stats.all + '</span></button><button type="button" title="The groups of NGOs suspended by the Ministry of Justice." class="btn" data-toggle="tooltip" data-section="suspended" data-filter="suspended">Suspended  <span title="" class="label label-inverse tip-left">' + ncos.State.Stats.suspended + '</span></button><button type="button" title="The groups of NGOs were started administrative cases on violations of foreign agents law." class="btn" data-toggle="tooltip" data-section="cases" data-filter="administrative case">Administrative cases <span title="" class="label label-inverse tip-left">' + ncos.State.Stats.cases + '</span></button><button type="button" title="The groups of NGOs received official orders to register as foreign agents within one month of their respective dates of notice." class="btn" data-toggle="tooltip" data-section="submissions" data-filter="notice of violations">Notice of violations <span title="" class="label label-inverse tip-left">' + ncos.State.Stats.submissions + '</span></button><button type="button" title="The groups of NGOs were warned of a need to register as foreign agents if they plan to carry out political activities or to receive foreign funding in the future." class="btn" data-toggle="tooltip" data-section="warnings" data-filter="warning">Warnings <span title="" class="label label-inverse tip-left">' + ncos.State.Stats.warnings + '</span></button><button type="button" title="Others types of sanctions" class="btn" data-toggle="tooltip" data-section="other" data-filter="other">Others <span title="" class="label label-inverse tip-left">' + ncos.State.Stats.other + '</span></button></div>');
  },
